...
# Registering the AuthenticationResource with the Falcon app  stats_sous_categorie        http://localhost:8000/oauth2callback
...
app.add_route('/oauth2callback', resource,suffix="oauth2callback")
